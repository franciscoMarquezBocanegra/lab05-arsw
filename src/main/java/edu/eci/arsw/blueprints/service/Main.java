...
public class Main {
    ...
    public static void main(String a[]) throws BlueprintNotFoundException, BlueprintPersistenceException {
        ...
        Blueprint currentBp = new Blueprint("Francisco", "casa#38", pts);
        bps.addNewBlueprint(currentBp);
        bps.addNewBlueprint(new Blueprint("Francisco", "casa#39"));
        bps.addNewBlueprint(new Blueprint("Carlos", "casa#12"));
        bps.addNewBlueprint(new Blueprint("Carlos", "casa#8"));
        ...
        bps.addNewBlueprint(new Blueprint("Carlos", "casa#77", ptsFilter1));
        bps.addNewBlueprint(new Blueprint("Carlos", "casa#78", ptsFilter2));
        ...
        bps.addNewBlueprint(new Blueprint("Francisco", "casa#99", ptsFilter1US));
        bps.addNewBlueprint(new Blueprint("Francisco", "casa#98", ptsFilter2US));
        Set<Blueprint> bpus = bps.getBlueprintsByAuthor("Francisco");
